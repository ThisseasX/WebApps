...
<%
  ...
  List<Candidate> list = VoterService.getVoteHistory(v);
%>
  ...
  <div class="row">
    <div class="col-md-6 col-md-offset-3">
      ...
      <div class="table-responsive">
            ...
            <td>
              <p data-placement="top" data-toggle="tooltip" title="vote">
                <%
                  if (c.getVotes() > 0) {
                %>
                <button class="btn btn-primary" data-title="yes">
                  <span class="glyphicon glyphicon-thumbs-up"></span>
                </button>
                <%
                } else {
                %>
                <button class="btn btn-danger" data-title="no">
        ...
        %>
        <div class="container">
          <h1 class="text-center text-danger col-md-6 col-md-offset-3"
